<script lang="ts">
  import { viewState, mcpStatus, navOpen } from "../stores";
...
<nav class="drawer" class:open={$navOpen}>
  <div class="drawer-header">
    <svg class="header-logo" viewBox="80 240 420 420">
    ...
    <button class="close-nav-btn" onclick={() => navOpen.set(false)} aria-label="Close menu">
  ...
  <div class="nav-items">
    ...
    <button
      ...
      onclick={() => navigate(navigateToSkills)}
    >
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <button
      ...
      onclick={() => navigate(navigateToLibrary)}
    >
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <button
      ...
      onclick={() => navigate(navigateToAgents)}
    >
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <button
      ...
      onclick={() => navigate(navigateToRecordings)}
    >
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <div class="drawer-footer">
    ...
    <button class="nav-item settings" onclick={() => navigate(navigateToSettings)}>
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
