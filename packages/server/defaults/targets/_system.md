...
Skill loading: Skill packs provide domain knowledge as skill:// MCP resources. Read _skill.md for UI selectors, data model, states, and gotchas. Read _roles/*.md for role-specific instructions.
